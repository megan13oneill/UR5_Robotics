...
class CameraController:
    def __init__(self):
        ...
        self.ax.grid(False)
        self.line_r, = self.ax.plot([], [], color='#E69F00', marker='o', markersize=4, linestyle='-', label='Red')
        self.line_g, = self.ax.plot([], [], color='#009E73', marker='^', markersize=4, linestyle='-', label='Green')
        self.line_b, = self.ax.plot([], [], color='#56B4E9', marker='s', markersize=4, linestyle='-', label='Blue')
        self.ax.legend(fontsize=16, loc='center left', bbox_to_anchor=(1.02, 0.5), borderaxespad=0., handlelength=3)
